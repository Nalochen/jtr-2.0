...
} from '../team-information-statistics/team-information-statistics.component';
...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, NgOptimizedImage, TeamInformationTrainingComponent, TeamInformationContactsComponent, TeamInformationStatisticsComponent, TeamInformationAboutUsComponent],
