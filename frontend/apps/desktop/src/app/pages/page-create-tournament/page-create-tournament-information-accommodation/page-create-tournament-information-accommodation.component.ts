...
export class PageCreateTournamentInformationAccommodationComponent {
  ...
  public accommodationTypeOptions: { label: string; value: AccommodationTypeEnum; }[] = []
  public breakfastAvailabilityOptions: { label: string; value: TournamentFoodMorningEnum; }[] = []
  public lunchAvailabilityOptions: { label: string; value: TournamentFoodNoonEnum; }[] = []
  public dinnerAvailabilityOptions: { label: string; value: TournamentFoodEveningEnum; }[] = []
  public gastronomyAvailabilityOptions: { label: string; value: TournamentFoodGastroEnum; }[] = []
  ...
  private initializeBreakfastAvailabilityOptions(): void {
    const options = [
      { label: 'food-morning-provided', value: TournamentFoodMorningEnum.PROVIDED },
  ...
  private initializeDinnerAvailabilityOptions(): void {
    const options = [
      { label: 'food-evening-provided', value: TournamentFoodEveningEnum.PROVIDED },
      { label: 'food-evening-grill-provided', value: TournamentFoodEveningEnum.GRILL_AVAILABLE },
  ...
  private initializeGastronomyAvailabilityOptions(): void {
    const options = [
      { label: 'food-gastro-on-the-course', value: TournamentFoodGastroEnum.ON_THE_COURSE },
